module SpreeNews
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_stylesheets
        inject_into_file "app/assets/stylesheets/store/all.css.scss", " *= require store/spree_news\n", :before => /\*\//, :verbose => true
        inject_into_file "app/assets/stylesheets/admin/all.css.scss", " *= require admin/spree_news\n", :before => /\*\//, :verbose => true
      end
